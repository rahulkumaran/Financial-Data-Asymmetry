# -*- coding: utf-8 -*-
"""
Created on Thu Apr 11 20:38:43 2019
...
data=pd.read_csv("bitcoin_data.csv")#,header= None)
...
print "Error from GBR, without using volatility",calc_error(Y_corr,Y1)
print "Error from RFR, without using volatility",calc_error(Y_corr,Y2)
